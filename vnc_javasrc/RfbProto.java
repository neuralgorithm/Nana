...
class RfbProto {
  ...
  void readVersionMsg() throws Exception {
    ...
    // :Neuralgorithm:
    // The server version, which is sent from the server first in the
    // original VNC protocol, has to be set at a fixed number in the
    // L7-proxy version, because in the L7-proxy protocol the client
    // has to talk first.
    ...
    serverMajor = 3; // set at a fixed number
    serverMinor = 8; // set at a fixed number
